...
const styles: Record<string, CSSProperties> = {
  ...
  td: { padding: '0.5rem 0.75rem', color: '#e2e8f0', borderBottom: '1px solid #1e293b' },
  qtyInput: {
  ...
  noteInput: {
    width: '160px', background: '#0f172a', color: '#e2e8f0', border: '1px solid #334155',
  ...
  formTitle: { color: '#f1f5f9', fontSize: '1rem', fontWeight: 600, margin: 0 },
